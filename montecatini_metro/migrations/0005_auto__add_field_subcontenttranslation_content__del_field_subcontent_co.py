...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubContentTranslation.content'
        db.add_column(u'montecatini_metro_subcontent_translation', 'content',
                      self.gf('ckeditor.fields.RichTextField')(default='n/d'),
                      keep_default=False)

        # Deleting field 'SubContent.content'
        db.delete_column(u'montecatini_metro_subcontent', 'content_id')


    def backwards(self, orm):
        # Deleting field 'SubContentTranslation.content'
        db.delete_column(u'montecatini_metro_subcontent_translation', 'content')

        # Adding field 'SubContent.content'
        db.add_column(u'montecatini_metro_subcontent', 'content',
